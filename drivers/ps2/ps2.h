...
/**
 * Initialize keyboard only using PIO, leaving the mouse pins untouched.
 * Added for frank-test: on the FRANK boards the mouse shares GP0/GP1
 * with UART0, so bringing it up costs the serial console.
 *
