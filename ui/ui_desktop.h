...
enum {
    ...
    CMD_CONSOLE, CMD_REPORT, CMD_OVERCLOCK,
    CMD_VIDEO_AUTO, CMD_VIDEO_HDMI, CMD_VIDEO_VGA, CMD_VIDEO_COMPOSITE,
    CMD_VIDEO_TESTCARD,
    CMD_AUDIO_PWM, CMD_AUDIO_I2S, CMD_AUDIO_TS, CMD_AUDIO_PCM5122,
    CMD_RUN_ALL, CMD_RUN_SELECTED, CMD_NESPAD, CMD_TAPE, CMD_PS2, CMD_LED, CMD_BURNIN,
    CMD_CONFIRM_LEGIBLE, CMD_HELP, CMD_KEYS,
};
